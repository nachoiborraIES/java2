...
!!! quote "Exercise 1"
    ...
    Implement the *Factory* pattern in the Exercise 6 of [this document](05e.md) as we have shown in previous example and test it.
...
!!! quote "Exercise 3"
    ...
    Update the *Animals* project of Exercise 1 of [this document](05e.md) and add an *animal factory* so that we no longer use the constructor of each animal type. 
